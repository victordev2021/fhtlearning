<div class="mb-4">
    ...
    {!! Form::text('title', null, ['class' => 'form-input block w-full mt-1' . ($errors->has('title') ? ' bg-red-200' : '')]) !!}
    @error('title')
...
<div class="mb-4">
    ...
    {!! Form::text('slug', null, ['class' => 'form-input block w-full mt-1' . ($errors->has('title') ? ' bg-red-200' : ''), 'readonly' => true]) !!}
    @error('slug')
        <strong class="text-xs text-red-600">{{ $message }}</strong>
    @enderror
</div>
<div class="mb-4">
    ...
    {!! Form::text('subtitle', null, ['class' => 'form-input block w-full mt-1' . ($errors->has('title') ? ' bg-red-200' : '')]) !!}
    @error('subtitle')
        <strong class="text-xs text-red-600">{{ $message }}</strong>
    @enderror
</div>
<div class="mb-4">
    ...
    {!! Form::textarea('description', null, ['class' => 'form-input block w-full mt-1' . ($errors->has('title') ? ' bg-red-200' : '')]) !!}
    @error('description')
        <strong class="text-xs text-red-600">{{ $message }}</strong>
    @enderror
</div>
...
<div class="grid grid-cols-2 gap-4">
    ...
    <div>
        ...
        {!! Form::file('file', ['class' => 'form-input' . ($errors->has('title') ? ' bg-red-200' : ''), 'style' => 'border-radius:0', 'id' => 'file', 'accept' => 'image/*']) !!}
        @error('file')
            <strong class="text-xs text-red-600">{{ $message }}</strong>
        @enderror
    </div>
