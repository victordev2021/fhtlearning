    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6 text-white">
            ...
            <div class="text-white">
                ...
                <p class="mb-2"><i class="mr-2 fas fa-chart-line"></i>Categoría: {{ $course->category->name }}</p>
        ...
        <div class="order-1 lg:order-2">
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    @can('enrolled', $course)
                        <a href="{{ route('course.status', $course) }}" class="btn btn-danger btn-block mt-4">Continuar con
                            el curso</a>
                    @else
